...
export default function ContactPage() {
                ...
                {/* <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-surface border border-border">
                    ...
                    <div>
                      ...
                      <a href="tel:+18885668927" className="text-sm text-primary font-bold hover:underline">(888) 566-8927</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 p-4 rounded-xl bg-surface border border-border">
                    ...
                    <div>
                      ...
                      <a href="mailto:support@optimusautoparts.com" className="text-sm text-primary font-bold hover:underline">support@optimusautoparts.com</a>
                    </div>
                  </div>
                </div> */}
  ...
  <div className="flex-none flex items-start gap-4 p-4 rounded-xl bg-surface border border-border">
    ...
    <div>
      <h3 className="font-semibold text-text">Phone</h3>
      <a href="tel:+18885668927" className="text-sm text-primary font-bold hover:underline whitespace-nowrap">(888) 566-8927</a>
    </div>
  </div>
