          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-fade-in-up">
              ...
              <p className="mt-6 text-lg text-text-muted max-w-xl leading-relaxed">
                We stock the highest quality OEM and aftermarket auto parts for every make and model. Get your car back on the road today.
              </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="mt-4 text-text-muted text-lg">
              We deliver unmatched quality and performance with our extensive inventory of premium auto parts.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Every part we sell is rigorously tested and verified to ensure maximum performance and longevity.",
                icon: (
              ...
              },
              {
                ...
                description: "We carry parts for all major makes and models. Finding the exact component you need has never been easier.",
                icon: (
                  <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              ...
              {
                title: "Fast Shipping",
                description: "Receive your parts delivered directly to your door within days. Getting you back on the road is our priority.",
                icon: (
                  <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
      ...
      <section className="py-20 sm:py-28 bg-surface border-t border-border relative overflow-hidden z-0">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="mt-4 text-text-muted text-lg">
              Getting your parts is simple. Three easy steps to get your vehicle running smoothly again.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Search our massive inventory or tell us exactly what you are looking for.",
                icon: (
              ...
              },
              {
                ...
                description: "Our experts verify that the part perfectly matches your vehicle's make, model, and year.",
                icon: (
                  <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
              ...
              },
              {
                ...
                description: "Get your parts delivered fast. Install them with confidence and get back on the road.",
                icon: (
                  <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
